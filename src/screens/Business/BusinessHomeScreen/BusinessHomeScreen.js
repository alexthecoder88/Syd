...
export default class BusinessHomeScreen extends Component {
  ...
  constructor(props) {
    super(props);
    this.businessHomeScreenStyles = new BusinessHomeScreenStyles(
    ...
    this.state = {
      items: {
        "2018-10-22": [
          {
            service: "Special manicure",
            customerName: "Tatyana Clerveaux",
            price: 500,
            time: "10am"
          },
          {
        ...
        "2018-10-23": [
          ...
          },
          {
            ...
            customerName: "Gay guy",
            price: 600,
            time: "2pm"
          }
        ],
        "2018-10-24": [],
        "2018-10-25": [{ service: "item 3 - any js object" }]
      }
    };
  }
