...
export default class LoginScreen extends Component {
  ...
  //Title section
  _createTitle = () => <Text style={this.styles.getStyles().titleContainer}>SYD</Text>
  ...
  _createButton(buttonText){
    ...
    return(
        <TouchableHighlight 
          ...
          onPress={() => buttonText ==="LOGIN" ? this._processAuthentication(null) : console.log("sign up")}
          underlayColor = 'gray'>
  ...
  _createTextInput(inputText){
    return(
        <TextInput style = {this.styles.getStyles().inputContainer}
  ...
  _createForgetPasswordLink = () => {
    const textContainerStyles = this.styles.getStyles().resetPasswordTextContainer;
    const touchableHighlightContainerStyles = this.styles.getStyles().resetPasswordContainer;
    return(
      <TouchableHighlight style={touchableHighlightContainerStyles} 
  ...
  render() {
    const loginAndSignUpButtonContainerStyles = this.styles.getStyles().loginAndSignUpButtonContainer;
    return (
